 ...
 <div class="email-confirmation">
   ...
   <div class="confirmation-container">
     <div class="confirmation-card">
       ...
       <!-- Estado de warning (cuenta ya verificada) -->
       <div v-else-if="errorType === 'already_verified'" class="warning-state">
         <div class="warning-icon">
           <div class="warning-circle">
             <span class="warning-exclamation">!</span>
           </div>
         </div>
         <h1 class="title-hero warning-title">Cuenta Ya Verificada</h1>
         <h2 class="subtitle">Tu email ya está confirmado</h2>
         <p class="description">
           {{ errorMessage }}
         </p>
       ...
       <!-- Footer - solo mostrar si NO es estado de éxito -->
       <div v-if="!isSuccess" class="footer-info">
         <p class="help-text">
           ¿Necesitas ayuda? 
   ...
   const processConfirmation = async () => {
     ...
     try {
       ...
       if (errorMsg.includes('expirado') || errorMsg.includes('expired')) {
         handleError('El enlace de verificación ha expirado. Los enlaces son válidos por 24 horas.', 'expired')
       } else if (errorMsg.includes('inválido') || errorMsg.includes('invalid') || errorMsg.includes('token')) {
         handleError('El enlace de verificación no es válido o ya fue utilizado.', 'invalid')
       } else if (errorMsg.includes('verificado') || errorMsg.includes('confirmed')) {
         handleError('Esta cuenta ya está verificada. Puedes iniciar sesión normalmente.', 'already_verified')
       } else {
...
.btn {
 ...
 min-height: 48px;
 font-size: 1rem;
 min-width: 160px; /* Para que ambos botones tengan el mismo ancho */
}
